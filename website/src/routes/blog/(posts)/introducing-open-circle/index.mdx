...
Open Circle is a [Open Circle](https://github.com/open-circle) that serves as the shared home for Valibot, Formisch, and future projects that share our philosophy around modularity, type safety, and developer experience. Think of the organization as a container for related projects. It is not a tool or library you install.
