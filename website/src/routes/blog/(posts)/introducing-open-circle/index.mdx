...
- Valibot and Formisch now live under [the Open Circle GitHub organization](https://github.com/open-circle)
- Nothing changes except the repository [URL](https://github.com/open-circle).
- Sponsorships are now handled transparently through [Open Collective](https://opencollective.com/valibot)
...
You can view the organization [here](https://github.com/open-circle).
